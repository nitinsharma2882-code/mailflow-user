...
contextBridge.exposeInMainWorld('api', {
  ...
  servers: {
    ...
    testSes:    (config)     => ipcRenderer.invoke('servers:testSes', config),
  },
  ...
  smtp: {
    ...
    parseCsv:      (filePath)      => ipcRenderer.invoke('smtp:parseCsv', filePath),
    exportResults: (results, type) => ipcRenderer.invoke('smtp:export', results, type),
    export:        (results, type) => ipcRenderer.invoke('smtp:export', results, type),
  },
  ...
  license: {
    ...
    getCurrentInstance:      ()       => ipcRenderer.invoke('license:getCurrentInstance'),
